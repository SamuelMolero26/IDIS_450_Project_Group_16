...
1. **Dependencies**: Ensure all required packages are installed with correct versions
   ```bash
   pip install --upgrade pandas numpy matplotlib seaborn scipy scikit-learn plotly pingouin
   ```

2. **Data Path**: Verify the raw data file exists at `Project4_USRegionalSales/Data-USRegionalSales.csv`

3. **Output Directories**: The scripts will create output files in the current directory. Ensure write permissions.

4. **Memory Issues**: The dataset is ~8K records. If you experience memory issues, consider running on a machine with at least 4GB RAM.

## 👥 Maintainers and Contributors

**Project Team:** IDIS 450 Project Group 16

**Primary Repository:** [SamuelMolero26/IDIS_450_Project_Group_16](https://github.com/SamuelMolero26/IDIS_450_Project_Group_16)
...
This project is part of an academic assignment for IDIS 450. Please refer to your course guidelines for usage and sharing policies.

## 🙏 Acknowledgments

- Dataset: US Regional Sales Data
- Course: IDIS 450 - Information Systems
- Libraries: pandas, numpy, matplotlib, seaborn, scikit-learn, plotly, scipy
